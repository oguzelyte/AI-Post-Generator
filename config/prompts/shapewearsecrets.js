function createContentPrompt(
  ...
  return `
    ...
    3. Write in the style of Nikkie de Jager (Nikkie Tutorials).
...
function createTitlePrompt(imagine) {
  return `You are an experienced content writer. You excel in creating compelling blog post titles. Your expertise is in the shapewear & beauty niche and you write in a friendly style. Your style inspiration is Callie King. You don't use big words like unveil, unleash or mysteries.
...
function createOutlinePrompt(title, key, numOfParagraphs) {
  return `
      ...
      You write your outlines in the style of Nikkie de Jager (Nikkie Tutorials).`;
}
